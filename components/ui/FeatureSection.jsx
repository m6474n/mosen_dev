...
export function FeaturesSectionDemo() {
  ...
  return (
    (<div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <h4
          className="text-3xl lg:text-7xl font-black lg:leading-tight font-sans  max-w-7xl mx-auto text-center tracking-tight  text-black dark:text-white">
...
export const SkeletonFour1 = ({className}) => {
  return (
    (<div
      className={cn("h-60 md:h-60  flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10", {className})}>
      <Globe className="absolute -right-10 md:-right-2 -bottom-[27rem] md:-bottom-[27rem]" />
    </div>)
  );
};
